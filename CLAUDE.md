...
O admin insere o PAT na aba "Senha" do painel → clica "Salvar Token". O token fica em `localStorage` (`amplia_github_token`) e é usado pelo botão Publicar para chamar a GitHub Contents API (`PUT /repos/joaovisoli617-ops/Jo-o-Visoli/contents/content.json`).
...
git remote set-url origin "https://TOKEN@github.com/joaovisoli617-ops/Jo-o-Visoli.git"
